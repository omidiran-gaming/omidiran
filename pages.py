...
const LANG_FA = {
  ...
  "آنلاین · Railway": "آنلاین · omidiran",
...
/* OMID Login Light / Day Theme */
html[data-login-theme="light"]{background:#eefcff}
html[data-login-theme="dark"]{background:#02070c}
...
html[data-login-theme="light"] body{
  color:#102338;
  background:
    radial-gradient(850px 520px at 8% 0%,rgba(34,197,94,.12),transparent 60%),
    radial-gradient(820px 560px at 92% 100%,rgba(14,165,233,.14),transparent 62%),
    linear-gradient(180deg,#eefcff 0%,#f5fbff 52%,#edf7f8 100%);
}
html[data-login-theme="light"] body::before{
  background-image:
    ...
    radial-gradient(circle at 50% 20%,rgba(255,255,255,.75),transparent 44%);
  background-size:36px 36px,36px 36px,auto;
}
html[data-login-theme="light"] .kicker{color:#44768a}
html[data-login-theme="light"] .lang{
  background:rgba(255,255,255,.72);
  border-color:rgba(14,165,233,.20);
  color:#0b7496;
  box-shadow:0 8px 22px rgba(22,88,111,.06);
}
html[data-login-theme="light"] .card{
  background:linear-gradient(145deg,rgba(255,255,255,.90),rgba(242,250,253,.86));
  border-color:rgba(14,165,233,.18);
  box-shadow:0 26px 80px rgba(28,72,91,.14),inset 0 1px 0 rgba(255,255,255,.95);
}
html[data-login-theme="light"] .card::before{
  background:linear-gradient(120deg,transparent 0 34%,rgba(14,165,233,.05) 45%,transparent 55%,rgba(34,197,94,.035) 76%,transparent 85%);
}
html[data-login-theme="light"] .brand-img{
  border-color:rgba(14,165,233,.24);
  box-shadow:0 0 24px rgba(14,165,233,.12);
}
html[data-login-theme="light"] .brand-name,
html[data-login-theme="light"] h1{color:#102338}
html[data-login-theme="light"] .brand-sub,
html[data-login-theme="light"] p.sub{color:#587585}
html[data-login-theme="light"] .accent{color:#087ea3;text-shadow:0 0 14px rgba(8,126,163,.10)}
html[data-login-theme="light"] .field label{color:#587787}
html[data-login-theme="light"] .input-shell input{
  background:rgba(255,255,255,.84);
  border-color:rgba(14,165,233,.16);
  color:#173247;
  box-shadow:inset 0 1px 0 rgba(255,255,255,.85);
}
html[data-login-theme="light"] .input-shell input::placeholder{color:#7b98a6}
html[data-login-theme="light"] .input-shell input:focus{
  border-color:rgba(14,165,233,.42);
  box-shadow:0 0 0 3px rgba(14,165,233,.08),0 0 24px rgba(14,165,233,.08);
}
html[data-login-theme="light"] .ic{color:#3f8192}
html[data-login-theme="light"] .btn{
  background:linear-gradient(135deg,#087ea3 0%,#0ea5e9 52%,#22c55e 100%);
  box-shadow:0 12px 30px rgba(14,165,233,.18),0 0 22px rgba(34,197,94,.08);
}
html[data-login-theme="light"] .meta{
  background:rgba(255,255,255,.66);
  border-color:rgba(14,165,233,.11);
}
html[data-login-theme="light"] .meta span{color:#668694}
html[data-login-theme="light"] .meta b{color:#2d6176}
html[data-login-theme="light"] .ok{color:#0f9f72}
html[data-login-theme="light"] .foot{color:#62808d}
</style><style id="omid-cyber-upgrade">
/* ═════ OMID CYBERCORE v2 · neon engineering HUD ═════ */
:root{
  --neon:#39e7ff;--neon2:#0aa8c4;--violet:#9b6cff;--cyan-soft:rgba(57,231,255,.12);
  --hud-line:rgba(57,231,255,.18);--hud-glow:rgba(57,231,255,.28);
}
html{scroll-behavior:smooth}
body{position:relative;isolation:isolate;background:
  radial-gradient(900px 520px at 10% -5%,rgba(0,174,204,.18),transparent 64%),
  radial-gradient(800px 560px at 95% 105%,rgba(92,68,255,.10),transparent 66%),
  linear-gradient(180deg,#01050a 0%,#020810 45%,#02050a 100%);}
body::before{content:"";position:fixed;inset:0;pointer-events:none;z-index:-1;background-image:linear-gradient(rgba(57,231,255,.028) 1px,transparent 1px),linear-gradient(90deg,rgba(57,231,255,.028) 1px,transparent 1px);background-size:32px 32px;mask-image:linear-gradient(to bottom,rgba(0,0,0,.95),rgba(0,0,0,.18));}
body::after{content:"";position:fixed;left:0;right:0;top:-10%;height:2px;pointer-events:none;z-index:250;background:linear-gradient(90deg,transparent 0%,rgba(57,231,255,.0) 15%,rgba(57,231,255,.75) 50%,rgba(155,108,255,.38) 70%,transparent 100%);box-shadow:0 0 24px rgba(57,231,255,.55);animation:omidScan 8s linear infinite;opacity:.75}
@keyframes omidScan{0%{transform:translateY(-20vh)}100%{transform:translateY(120vh)}}
.night-mode .metric,.night-mode .card,.night-mode .create-panel,.night-mode .vless-box,.night-mode .modal,.night-mode .modal-v2,.night-mode .traf-chart-card,.night-mode .traf-main-stat,.night-mode .traf-mini{box-shadow:0 18px 44px rgba(0,0,0,.34),inset 0 1px 0 rgba(255,255,255,.025),0 0 0 1px rgba(57,231,255,.02)}
.night-mode .metric::before,.night-mode .card::before,.night-mode .create-panel::before,.night-mode .vless-box::after{content:"";position:absolute;inset:0;border-radius:inherit;pointer-events:none;background:linear-gradient(125deg,transparent 0 42%,rgba(255,255,255,.035) 49%,transparent 57%);opacity:.7}
.sidebar{box-shadow:20px 0 80px rgba(0,0,0,.34),inset -1px 0 0 rgba(57,231,255,.05)}
.nav-it.on{box-shadow:inset 0 0 32px rgba(11,167,196,.08),0 0 28px rgba(11,167,196,.08)}
.metric,.card,.traf-mini,.sub-card,.conn-card-v2,.lrow-v2,.vless-box,.create-panel,.modal,.modal-v2{transition:transform .22s ease,border-color .22s ease,box-shadow .22s ease,background .35s ease;will-change:transform}
.metric:hover,.card:hover,.traf-mini:hover,.sub-card:hover,.conn-card-v2:hover,.lrow-v2:hover{transform:translateY(-3px)}
.btn-p{background:linear-gradient(135deg,#05667d 0%,#0aa8c4 48%,#7861ff 100%);box-shadow:0 10px 28px rgba(10,168,196,.18),0 0 18px rgba(57,231,255,.08)}
.btn-p:hover{filter:brightness(1.10);box-shadow:0 12px 32px rgba(10,168,196,.24),0 0 24px rgba(57,231,255,.13)}
.lang-btn,.side-lang,.theme-btn,.theme-mob{position:relative;overflow:hidden}
.lang-btn::before,.side-lang::before,.theme-btn::before,.theme-mob::before{content:"";position:absolute;inset:0;background:linear-gradient(110deg,transparent 20%,rgba(255,255,255,.08) 50%,transparent 80%);transform:translateX(-120%);transition:transform .5s ease}
.lang-btn:hover::before,.side-lang:hover::before,.theme-btn:hover::before,.theme-mob:hover::before{transform:translateX(120%)}
/* cyber day theme */
[data-theme="light"] body{background:linear-gradient(180deg,#eaf8fb 0%,#eef3fb 44%,#e7edf7 100%);color:#102033}
[data-theme="light"] body::before{background-image:linear-gradient(rgba(7,132,163,.055) 1px,transparent 1px),linear-gradient(90deg,rgba(7,132,163,.055) 1px,transparent 1px);opacity:.85}
[data-theme="light"] body::after{opacity:.30;box-shadow:0 0 12px rgba(7,132,163,.25)}
[data-theme="light"] .sidebar{background:linear-gradient(180deg,rgba(240,251,254,.96),rgba(226,239,247,.95));box-shadow:18px 0 40px rgba(20,70,90,.10)}
[data-theme="light"] .metric,[data-theme="light"] .card,[data-theme="light"] .traf-mini,[data-theme="light"] .traf-chart-card,[data-theme="light"] .vless-box,[data-theme="light"] .create-panel,[data-theme="light"] .modal,[data-theme="light"] .modal-v2{background:linear-gradient(145deg,rgba(255,255,255,.88),rgba(241,248,252,.84));box-shadow:0 16px 34px rgba(33,72,95,.08),inset 0 1px 0 rgba(255,255,255,.85)}
[data-theme="light"] .metric:hover,[data-theme="light"] .card:hover,[data-theme="light"] .traf-mini:hover{box-shadow:0 18px 42px rgba(33,72,95,.12),0 0 0 1px rgba(7,132,163,.06)}
[data-theme="light"] .tb-title,[data-theme="light"] .card-title,[data-theme="light"] .m-val,[data-theme="light"] .metric .m-label,[data-theme="light"] .logo-name{color:#102033}
[data-theme="light"] .logo-sub,[data-theme="light"] .tb-sub,[data-theme="light"] .m-sub{color:#547283}
[data-theme="light"] .sidebar .nav-it{color:#4F6978}[data-theme="light"] .sidebar .nav-it:hover{color:#173A4B;background:linear-gradient(90deg,rgba(27,170,190,.11),rgba(27,170,190,.03))}[data-theme="light"] .sidebar .nav-it.on{color:#123545;background:linear-gradient(90deg,rgba(27,170,190,.18),rgba(27,170,190,.05));box-shadow:inset 0 0 24px rgba(27,170,190,.06)}[data-theme="light"] .sidebar .nav-it i{color:#2C8BA4}[data-theme="light"] .sidebar .nav-it.on i{color:#087F99}[data-theme="light"] .sidebar .nav-badge{display:none !important}[data-theme="light"] .sidebar .nav-sec{color:#397282}
/* deterministic language + sidebar direction */
body.ui-en{direction:ltr;text-align:left}
body.ui-fa{direction:rtl;text-align:right}

/* The navigation rail is ALWAYS LTR and ALWAYS on the left.
   Only the label alignment/content language changes. */
.sidebar{direction:ltr !important}
.main{margin-left:var(--sidebar-w) !important;margin-right:0 !important}

.sidebar .logo,
.sidebar .side-telemetry,
.sidebar .nav-wrap,
.sidebar .sb-foot{direction:ltr}

.nav-wrap{direction:ltr !important}
.nav-sec{direction:ltr;text-align:left}
.nav-it{
...
.nav-it > i{grid-column:1;grid-row:1;justify-self:center}
.nav-it > .nav-label{grid-column:2;grid-row:1;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.nav-badge-empty{visibility:hidden}
body.ui-en .nav-it > .nav-label{text-align:left;direction:ltr}
body.ui-fa .nav-it > .nav-label{text-align:right;direction:rtl}
body.ui-en .nav-sec{text-align:left}
body.ui-fa .nav-sec{text-align:right}

/* Remove the previous pseudo-element English labels. */
body.ui-en .nav-it::after{content:none !important}
body.ui-en .nav-sec::after{content:none !important}

@media(max-width:1050px){
  body.ui-fa .main,
  body.ui-en .main{margin-left:0 !important;margin-right:0 !important}
  body.ui-fa .sidebar,
  body.ui-en .sidebar{left:0 !important;right:auto !important;transform:translateX(-105%)}
  body.ui-fa .sidebar.open,
  body.ui-en .sidebar.open{transform:translateX(0)}
}

html[data-login-theme="light"] .foot span,html[data-login-theme="light"] .meta span{direction:ltr}
body.login-en .card,body.login-en .hud{direction:ltr;text-align:left}
...
.pw-input{width:100%;padding:11px 14px 11px 42px;border-radius:11px;border:1px solid var(--card-b);background:rgba(0,0,0,.18);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.15s}
...
:root{
 ...
 --accent:#0B738D;--accent2:#49CFEF;--accent-d:rgba(11,115,141,.13);
 --green:#20C997;--green-bg:rgba(32,201,151,.10);--green-t:#5BE0B2;
 --red:#EF5B6B;--red-bg:rgba(239,91,107,.10);--red-t:#FF8D9A;
 --amber:#F5B84B;--amber-bg:rgba(245,184,75,.10);--amber-t:#FFD58A;
 --purple:#A36AF4;--purple-bg:rgba(163,106,244,.10);
 --t1:#ECF9FF;--t2:#95B6C6;--t3:#507183;
 --sidebar-w:264px;--radius:20px;--shadow:0 12px 40px rgba(0,0,0,.38)
}
body{background:radial-gradient(circle at 7% 8%,rgba(8,111,134,.13),transparent 26%),radial-gradient(circle at 95% 90%,rgba(30,74,95,.14),transparent 28%),#040A12}
body::before{content:"";position:fixed;inset:0;pointer-events:none;background:linear-gradient(120deg,transparent 0 38%,rgba(70,217,241,.025) 46%,transparent 58%),linear-gradient(rgba(71,206,235,.022) 1px,transparent 1px),linear-gradient(90deg,rgba(71,206,235,.018) 1px,transparent 1px);background-size:auto,42px 42px,42px 42px;z-index:0}
.sidebar{background:linear-gradient(180deg,rgba(6,20,32,.90),rgba(4,12,21,.86));backdrop-filter:blur(22px);border-left-color:rgba(69,199,232,.18);box-shadow:-18px 0 55px rgba(0,0,0,.14)}
.logo{padding:22px 17px 18px;border-bottom-color:rgba(69,199,232,.14)}
.logo-img,.mob-logo{border-radius:13px;box-shadow:0 0 22px rgba(0,174,206,.24),0 0 12px rgba(255,0,177,.12)}
.logo-name{font-size:13px;letter-spacing:.03em}.logo-sub{color:#6E95A7}
.nav-sec{letter-spacing:.08em;color:#557B8D}
.nav-it{border-radius:12px;transition:all .18s ease;position:relative}
.nav-it:hover{background:rgba(49,171,198,.08);transform:translateX(-2px)}
.nav-it.on{background:linear-gradient(90deg,rgba(9,105,129,.23),rgba(9,105,129,.07));border-color:rgba(69,199,232,.20);box-shadow:inset 0 0 25px rgba(8,108,130,.06)}
.nav-it.on::before{background:linear-gradient(180deg,#45D2EE,#087991);box-shadow:0 0 12px rgba(69,210,238,.45)}
.theme-btn{background:rgba(10,89,109,.12);border-color:rgba(69,199,232,.14);color:#A8D4E1}.theme-btn:hover{background:rgba(10,110,133,.18)}
.main{position:relative;z-index:1}
.metric,.card,.create-panel,.vless-box,.modal,.modal-v2,.traf-chart-card,.traf-main-stat,.traf-mini{background:linear-gradient(145deg,rgba(10,29,43,.62),rgba(5,16,27,.56));backdrop-filter:blur(16px);border-color:rgba(69,199,232,.13);box-shadow:0 12px 30px rgba(0,0,0,.18)}
.metric:hover,.traf-mini:hover,.card:hover{border-color:rgba(69,199,232,.28);box-shadow:0 16px 38px rgba(0,0,0,.24)}
.tb-title i,.card-title i,.traf-chart-title i,.vl-title i{color:#43CDEB}
.btn-p{background:linear-gradient(135deg,#075F73,#0B97B5);box-shadow:0 8px 22px rgba(0,117,145,.22)}
.btn-p:hover{background:linear-gradient(135deg,#087A92,#11A7C1)}
.btn-g{background:rgba(8,105,128,.11);color:#63D8EF;border-color:rgba(69,199,232,.15)}
.btn-o{background:rgba(255,255,255,.015);border-color:rgba(69,199,232,.12)}
.btn-pur{background:rgba(139,86,223,.11);border-color:rgba(163,106,244,.18)}
.vless-box::before{background:radial-gradient(circle,rgba(11,115,141,.19),transparent 70%)}
.vl-code{color:#73DAF0;background:rgba(0,0,0,.25);border-color:rgba(69,199,232,.12)}
.badge.bg-blue{background:rgba(11,115,141,.15);color:#63D7EE}.bg-purple{background:rgba(163,106,244,.11);color:#BD91FF}
.cp-head-icon,.m-icon{box-shadow:0 0 20px rgba(11,115,141,.14)}
.modal-bg{backdrop-filter:blur(8px)}
/* medium motion */
.metric,.card,.btn,.nav-it,.traf-mini{transition-duration:.22s}
.lang-btn{display:flex;align-items:center;justify-content:center;gap:6px;background:rgba(11,115,141,.12);border:1px solid rgba(69,199,232,.14);color:#8FE4F3;border-radius:10px;padding:8px 10px;font:600 11px Vazirmatn,sans-serif;cursor:pointer;transition:.18s;width:100%;margin-bottom:7px}.lang-btn:hover{background:rgba(11,115,141,.20);border-color:rgba(69,199,232,.25);transform:translateY(-1px)}.lang-wide{letter-spacing:.02em}.mob-right .lang-btn{width:auto;height:34px;margin:0;padding:0 9px;font-size:9.5px}body.ui-en .nav-label{display:block}
...
/* ═══════════════════════════════════════════════════════════════════════
   OMID-IRAN PANEL · CYBER DAY THEME
   Bright engineering UI: emerald + electric blue
   ═══════════════════════════════════════════════════════════════════════ */
[data-theme="light"]{
  --bg:#EEF7F8;--bg2:#E3F1F4;--bg3:#D6E9EE;
  --card:rgba(255,255,255,.78);--card-b:rgba(12,132,164,.18);--card-bh:rgba(12,132,164,.38);
  --accent:#087EA4;--accent2:#0E9ED0;--accent-d:rgba(14,158,208,.09);
  --green:#059669;--green-bg:rgba(5,150,105,.10);--green-t:#047857;
  --red:#DC3545;--red-bg:rgba(220,53,69,.08);--red-t:#B42333;
  --amber:#D97706;--amber-bg:rgba(217,119,6,.09);--amber-t:#A15C00;
  --purple:#6957D8;--purple-bg:rgba(105,87,216,.08);
  --t1:#0D2230;--t2:#3E6170;--t3:#6B8792;
  --shadow:0 14px 38px rgba(20,91,108,.12);
}
html[data-theme="light"]{background:#F7FCFD}
html[data-theme="dark"]{background:#02070c}
[data-theme="light"] body,
body[data-theme="light"]{
  background:
    radial-gradient(900px 520px at 10% 0%,rgba(14,158,208,.12),transparent 58%),
    radial-gradient(720px 520px at 92% 100%,rgba(5,150,105,.10),transparent 60%),
    linear-gradient(180deg,#F7FCFD 0%,#EDF7F8 48%,#E7F2F4 100%);
  color:var(--t1);
}
[data-theme="light"] body::after{
  opacity:.62;
  background-image:
    linear-gradient(rgba(8,126,164,.055) 1px,transparent 1px),
    linear-gradient(90deg,rgba(5,150,105,.042) 1px,transparent 1px);
  background-size:34px 34px;
  mask-image:linear-gradient(to bottom,black,transparent 92%);
}
[data-theme="light"] body::before{
  top:82px;
  background:linear-gradient(90deg,transparent,rgba(14,158,208,.32),rgba(5,150,105,.28),transparent);
  box-shadow:0 0 18px rgba(14,158,208,.12);
}
[data-theme="light"] .sidebar{
  background:linear-gradient(180deg,rgba(248,253,254,.96),rgba(228,242,245,.95));
  border-right-color:rgba(12,132,164,.18);
  box-shadow:18px 0 42px rgba(24,88,103,.10);
  backdrop-filter:blur(22px);
}
[data-theme="light"] .logo{border-bottom-color:rgba(12,132,164,.14)}
[data-theme="light"] .logo-img,
[data-theme="light"] .mob-logo{border-color:rgba(14,158,208,.28);box-shadow:0 0 18px rgba(14,158,208,.18),0 0 12px rgba(5,150,105,.10)}
[data-theme="light"] .logo-name{color:#0C2633}
[data-theme="light"] .logo-sub{color:#4D7886}
[data-theme="light"] .nav-sec{color:#5A808D}
[data-theme="light"] .nav-it{color:#4C6F7C}
[data-theme="light"] .nav-it:hover{background:linear-gradient(90deg,rgba(14,158,208,.10),rgba(5,150,105,.045));color:#0C6076;transform:translateX(2px)}
[data-theme="light"] .nav-it.on{background:linear-gradient(90deg,rgba(14,158,208,.15),rgba(5,150,105,.075));color:#0B5265;border-left-color:#0E9ED0;box-shadow:inset 0 0 26px rgba(14,158,208,.05),0 6px 18px rgba(14,158,208,.07)}
[data-theme="light"] .nav-it.on::before{background:linear-gradient(180deg,#18BFEF,#0A7EA3);box-shadow:0 0 12px rgba(14,158,208,.35)}
[data-theme="light"] .nav-it i{color:#4D8798}
[data-theme="light"] .nav-it.on i{color:#0B9DCF}
[data-theme="light"] .nav-badge{display:none !important}
[data-theme="light"] .side-telemetry{background:linear-gradient(135deg,rgba(255,255,255,.88),rgba(232,247,244,.78));border-color:rgba(14,158,208,.16);box-shadow:inset 0 0 25px rgba(14,158,208,.035),0 8px 22px rgba(30,90,105,.06)}
[data-theme="light"] .telemetry-head{color:#517887}
[data-theme="light"] .telemetry-grid span{color:#73919B}
[data-theme="light"] .telemetry-grid b{color:#244F60}
[data-theme="light"] .sb-foot{border-top-color:rgba(12,132,164,.12);background:linear-gradient(180deg,transparent,rgba(5,150,105,.045))}
[data-theme="light"] .side-lang,
[data-theme="light"] .theme-btn{background:linear-gradient(135deg,rgba(14,158,208,.08),rgba(5,150,105,.07));border-color:rgba(14,158,208,.16);color:#0B708C}
[data-theme="light"] .side-lang:hover,
[data-theme="light"] .theme-btn:hover{background:rgba(14,158,208,.13);color:#075F76}
[data-theme="light"] .tb-title{color:#0D2B39}
[data-theme="light"] .tb-title i{color:#0E9ED0}
[data-theme="light"] .tb-sub{color:#658490}
[data-theme="light"] .badge.bg-green{background:rgba(5,150,105,.11);color:#047857}
[data-theme="light"] .badge.bg-blue{background:rgba(14,158,208,.11);color:#087EA4}
[data-theme="light"] .metric,
[data-theme="light"] .card,
[data-theme="light"] .create-panel,
[data-theme="light"] .vless-box,
[data-theme="light"] .modal,
[data-theme="light"] .modal-v2,
[data-theme="light"] .traf-chart-card,
[data-theme="light"] .traf-main-stat,
[data-theme="light"] .traf-mini{background:linear-gradient(145deg,rgba(255,255,255,.84),rgba(242,250,251,.78));border-color:rgba(12,132,164,.15);box-shadow:0 13px 30px rgba(28,90,106,.07),inset 0 1px 0 rgba(255,255,255,.9)}
[data-theme="light"] .metric:hover,
[data-theme="light"] .traf-mini:hover,
[data-theme="light"] .card:hover{border-color:rgba(14,158,208,.30);box-shadow:0 18px 38px rgba(24,90,107,.10),0 0 0 1px rgba(5,150,105,.035)}
[data-theme="light"] .metric .m-label,
[data-theme="light"] .metric .m-val,
[data-theme="light"] .card-title,
[data-theme="light"] .traf-main-val{color:#0D2B39}
[data-theme="light"] .m-sub,
[data-theme="light"] .traf-main-label{color:#668591}
[data-theme="light"] .btn-p{background:linear-gradient(135deg,#0A8FBC 0%,#0DA7D4 52%,#08A978 100%);box-shadow:0 8px 20px rgba(14,158,208,.18)}
[data-theme="light"] .btn-p:hover{filter:brightness(1.04);transform:translateY(-1px)}
[data-theme="light"] .btn-g{background:linear-gradient(135deg,rgba(14,158,208,.08),rgba(5,150,105,.06));color:#087EA4;border-color:rgba(14,158,208,.17)}
[data-theme="light"] .btn-g:hover{background:rgba(14,158,208,.14);color:#075F76}
[data-theme="light"] .vl-code{background:linear-gradient(135deg,rgba(14,158,208,.045),rgba(5,150,105,.035));border-color:rgba(14,158,208,.14);color:#0B7898}
[data-theme="light"] .vless-box::before{background:radial-gradient(circle,rgba(14,158,208,.12),transparent 70%)}
[data-theme="light"] .copy-all-bar{background:linear-gradient(110deg,#0A8FBC 0%,#0D9FC9 46%,#08A979 100%);box-shadow:0 12px 30px rgba(11,146,161,.18)}
[data-theme="light"] .copy-all-btn{color:#087EA4}
[data-theme="light"] .lock-card{background:linear-gradient(145deg,rgba(255,255,255,.90),rgba(239,250,247,.86));border-color:rgba(14,158,208,.16)}
[data-theme="light"] .lock-banner{background:linear-gradient(150deg,rgba(14,158,208,.12),rgba(5,150,105,.06) 70%)}
[data-theme="light"] .lock-title{color:#0D2B39}
[data-theme="light"] .lock-sub,[data-theme="light"] .lock-footer{color:#6A8791}
[data-theme="light"] .lock-inp{background:rgba(14,158,208,.035);border-color:rgba(14,158,208,.15);color:#0D2B39}
[data-theme="light"] .lock-inp:focus{box-shadow:0 0 0 3px rgba(14,158,208,.09)}
[data-theme="light"] .toast{box-shadow:0 14px 34px rgba(28,90,106,.12)}


/* ═════ OMID v1.2.4 · Light theme hard-surface cleanup ═════ */
[data-theme="light"] .mob-top{
  background:linear-gradient(180deg,rgba(250,254,255,.96),rgba(236,248,250,.93));
  border-bottom-color:rgba(12,132,164,.13);box-shadow:0 8px 28px rgba(37,99,121,.08);color:#0D2B39;
}
[data-theme="light"] .mob-title{color:#0D2B39}
[data-theme="light"] .mob-subtitle{color:#5D8290}
[data-theme="light"] .top-status{color:#0B7D63;background:rgba(5,150,105,.07);border-color:rgba(5,150,105,.14)}
[data-theme="light"] .menu-btn,
[data-theme="light"] .theme-mob{background:linear-gradient(135deg,rgba(14,158,208,.08),rgba(5,150,105,.07));border-color:rgba(14,158,208,.16);color:#0B708C}
[data-theme="light"] .cp-block,
[data-theme="light"] .proto-card,
[data-theme="light"] .srv-tile,
[data-theme="light"] .sub-card-stats,
[data-theme="light"] .lrow-v2-check,
...
[data-theme="light"] .fi,
[data-theme="light"] .fs,
[data-theme="light"] .lock-inp,
[data-theme="light"] .cfg-vless{
  background:rgba(255,255,255,.76)!important;color:#16394A!important;border-color:rgba(14,158,208,.16)!important;
}
[data-theme="light"] .cp-block,
[data-theme="light"] .srv-tile,
[data-theme="light"] .proto-card{box-shadow:0 8px 22px rgba(28,90,106,.045)}
[data-theme="light"] .cfg-card,
[data-theme="light"] .conn-card{
  background:linear-gradient(145deg,rgba(255,255,255,.92),rgba(239,249,249,.86))!important;
  border-color:rgba(12,132,164,.14)!important;box-shadow:0 12px 30px rgba(24,90,107,.07)!important;
}
[data-theme="light"] .cfg-card:hover,
[data-theme="light"] .conn-card:hover{box-shadow:0 16px 34px rgba(24,90,107,.10)!important}
[data-theme="light"] .cfg-tear::before,
[data-theme="light"] .cfg-tear::after{background:var(--bg)}
[data-theme="light"] #ws-log{
  background:linear-gradient(145deg,rgba(255,255,255,.90),rgba(239,249,249,.82))!important;
  color:#234D5D!important;border-color:rgba(14,158,208,.14)!important;
}
[data-theme="light"] .cfg-vless{color:#0B7898!important}
[data-theme="light"] .sub-card-url-text,
[data-theme="light"] .sub-url{color:#4F5DB7}
[data-theme="light"] .btn-o{background:rgba(255,255,255,.80);color:#315669;border-color:rgba(12,132,164,.14)}
[data-theme="light"] .btn-pur{background:rgba(105,87,216,.09);color:#5B4BC2;border-color:rgba(105,87,216,.16)}
[data-theme="light"] .cl{background:rgba(14,158,208,.05);color:#547281;border-color:rgba(14,158,208,.12)}
[data-theme="light"] .modal-bg{background:rgba(12,35,45,.28)}
/* ══════════════════════════════════════════════════════════
   Sidebar position — dynamic by language
   FA (فارسی)  →  sidebar on RIGHT
   EN (English) →  sidebar on LEFT
   ══════════════════════════════════════════════════════════ */

/* ── EN mode: sidebar LEFT ── */
body.ui-en .sidebar{
  left:0 !important; right:auto !important;
  border-left:0 !important;
  border-right:1px solid var(--card-b) !important;
}
body.ui-en .main{
  margin-left:var(--sidebar-w) !important;
  margin-right:0 !important;
}
body.ui-en .sb-close{left:auto !important; right:12px !important}
body.ui-en .mob-top{padding:0 18px 0 calc(var(--sidebar-w) + 18px) !important}

/* ── FA mode: sidebar RIGHT ── */
body.ui-fa .sidebar{
...
body.ui-fa .sb-close{right:auto !important; left:12px !important}
body.ui-fa .mob-top{padding:0 calc(var(--sidebar-w) + 18px) 0 18px !important}

/* ── Mobile: slide-in from correct side ── */
@media(max-width:1050px){
  body.ui-en .sidebar{
    left:0 !important; right:auto !important;
    transform:translateX(-105%);
  }
  body.ui-en .sidebar.open{
  ...
  body.ui-en .mob-top,
  body.ui-fa .mob-top{padding:0 14px !important}
  body.ui-en .sb-close{left:auto !important; right:12px !important}
  body.ui-fa .sb-close{right:auto !important; left:12px !important}
}
/* ═══════════════════════════════════════════════════════════════════════
   OMID GAMING CORE v3 · Cyber HUD Theme · v1.3.0
   Neon glow + corner brackets + HUD numbers + terminal code
   ═══════════════════════════════════════════════════════════════════════ */
:root{
  --g-neon:#00f0ff;
  --g-magenta:#ff2d95;
...
.card,.traf-chart-card{position:relative}

/* Neon glow on every card */
.metric,.card,.cfg-card,.conn-card-v2,.sub-card,.create-panel,.vless-box,
.traf-mini,.traf-chart-card,.traf-main-stat{
  box-shadow:
...
.metric:hover,.card:hover,.cfg-card:hover,.conn-card-v2:hover,.sub-card:hover{
  transform:translateY(-4px);
  box-shadow:
    0 0 0 1px rgba(0,240,255,.35),
    0 0 22px rgba(0,240,255,.18),
    0 0 40px rgba(176,38,255,.10),
    0 18px 42px rgba(0,0,0,.5);
}

/* Corner brackets (HUD) */
.metric::before,.card::after,.cfg-card::after,.traf-chart-card::after,
.create-panel::after,.sub-card::after{
  content:"";position:absolute;inset:0;pointer-events:none;
  border-radius:inherit;
  background-image:
    linear-gradient(90deg,#00f0ff,#00f0ff),
    linear-gradient(0deg,#00f0ff,#00f0ff),
    linear-gradient(90deg,#ff2d95,#ff2d95),
    linear-gradient(0deg,#ff2d95,#ff2d95),
    linear-gradient(90deg,#ff2d95,#ff2d95),
    linear-gradient(0deg,#ff2d95,#ff2d95),
    linear-gradient(90deg,#00f0ff,#00f0ff),
    linear-gradient(0deg,#00f0ff,#00f0ff);
...
/* HUD monospace numbers */
.m-val,.traf-main-val,.conn-hero-val,.traf-mini-val,.sub-card-stat-val{
  font-family:ui-monospace,'JetBrains Mono','Fira Code',monospace;
  letter-spacing:-.03em;
  text-shadow:0 0 8px rgba(0,240,255,.55),0 0 22px rgba(0,240,255,.22);
}
.tb-title,.card-title,.traf-chart-title,.cp-head-title,
.sub-card-name-v2,.cfg-label{text-shadow:0 0 12px rgba(0,240,255,.25)}
.tb-title i,.card-title i,.traf-chart-title i,.cp-head-icon i{
  filter:drop-shadow(0 0 8px #00f0ff);
}

/* Sidebar nav neon indicator */
.nav-it{position:relative;transition:all .22s cubic-bezier(.34,1.56,.64,1)}
.nav-it::before{
...
body.ui-fa .nav-it::before{left:auto;right:0;border-radius:4px 0 0 4px}
.nav-it.on::before,.nav-it:hover::before{height:60%}
.nav-it.on{
  background:linear-gradient(90deg,rgba(0,240,255,.14),rgba(176,38,255,.06) 60%,transparent);
  text-shadow:0 0 14px rgba(0,240,255,.55);
}
body.ui-fa .nav-it.on{
  background:linear-gradient(270deg,rgba(0,240,255,.14),rgba(176,38,255,.06) 60%,transparent);
}
.nav-it.on i{color:#00f0ff!important;filter:drop-shadow(0 0 6px #00f0ff)}

/* Logo pulse */
.logo-img,.mob-logo{animation:logoGlow 3.2s ease-in-out infinite}
@keyframes logoGlow{
  0%,100%{box-shadow:0 0 22px rgba(0,240,255,.4),0 0 10px rgba(176,38,255,.3)}
  50%{box-shadow:0 0 34px rgba(0,240,255,.7),0 0 18px rgba(176,38,255,.55)}
}
...
.btn-p{
  background:linear-gradient(135deg,#00a0c0 0%,#00d4ff 45%,#b026ff 100%)!important;
  box-shadow:0 0 20px rgba(0,240,255,.35),0 8px 24px rgba(176,38,255,.28)!important;
}
.btn-p:hover{
  box-shadow:0 0 30px rgba(0,240,255,.6),0 12px 32px rgba(176,38,255,.45)!important;
}

/* LEDs glow */
.dot.dg.pulse,.conn-live-dot,.telemetry-led,.cfg-status-dot{
  box-shadow:0 0 6px currentColor,0 0 14px currentColor,0 0 22px currentColor;
}

/* Progress bars shimmer */
.ubar-f,.spfill{position:relative;overflow:hidden}
.ubar-f::after,.spfill::after{
...
/* VLESS terminal + blinking cursor */
.vl-code{
  background:rgba(0,5,10,.75)!important;
  border:1px solid rgba(0,240,255,.32)!important;
  color:#00f0ff!important;
  text-shadow:0 0 5px rgba(0,240,255,.55);
  font-family:ui-monospace,monospace!important;
  box-shadow:inset 0 0 30px rgba(0,240,255,.06),0 0 18px rgba(0,240,255,.08);
}
.vl-code::after{
...
/* Badges glow */
.badge{font-family:ui-monospace,monospace;letter-spacing:.06em}
.badge.bg-green{box-shadow:0 0 14px rgba(38,230,163,.4)}
.badge.bg-blue{box-shadow:0 0 14px rgba(0,240,255,.4)}
.badge.bg-purple{box-shadow:0 0 14px rgba(176,38,255,.35)}

/* Metric icon pulse ring */
.m-icon{position:relative}
.m-icon::after{
  content:"";position:absolute;inset:-5px;
  border:1px solid currentColor;border-radius:inherit;
  opacity:.35;animation:iconPulse 3s ease-in-out infinite;pointer-events:none;
}
@keyframes iconPulse{
...
/* Connection card radar scan */
.conn-card-v2{overflow:hidden}
.conn-card-v2::after{
  content:"";position:absolute;top:-100%;left:0;right:0;height:100%;
  background:linear-gradient(180deg,transparent,rgba(0,240,255,.09),transparent);
  animation:cardScan 4.5s linear infinite;pointer-events:none;
}
@keyframes cardScan{0%{top:-100%}100%{top:100%}}

/* Inputs neon focus */
.fi:focus,.fs:focus,.cp-input-full:focus,.modal-v2-input:focus,.pw-input:focus{
  border-color:rgba(0,240,255,.55)!important;
  box-shadow:0 0 0 3px rgba(0,240,255,.1),0 0 22px rgba(0,240,255,.15)!important;
}

/* Toast glow */
.toast{
  box-shadow:0 0 0 1px rgba(0,240,255,.22),0 16px 50px rgba(0,0,0,.5),
             0 0 30px rgba(0,240,255,.15)!important;
}

/* LIGHT MODE softening */
[data-theme="light"] .metric::before,
[data-theme="light"] .card::after,
[data-theme="light"] .cfg-card::after,
[data-theme="light"] .traf-chart-card::after,
[data-theme="light"] .create-panel::after,
[data-theme="light"] .sub-card::after{opacity:.28}
[data-theme="light"] .metric:hover,
[data-theme="light"] .card:hover,
[data-theme="light"] .cfg-card:hover{
  box-shadow:0 0 0 1px rgba(8,126,164,.35),0 14px 34px rgba(8,126,164,.14);
}
[data-theme="light"] .vl-code{
  background:rgba(0,240,255,.06)!important;
  color:#087ea4!important;
  text-shadow:none;
  border-color:rgba(8,126,164,.32)!important;
}
[data-theme="light"] .vl-code::after{color:#087ea4}
[data-theme="light"] .m-val,
[data-theme="light"] .traf-main-val,
[data-theme="light"] .conn-hero-val,
[data-theme="light"] .traf-mini-val{text-shadow:0 0 6px rgba(8,126,164,.12)}
[data-theme="light"] .tb-title,
[data-theme="light"] .card-title,
[data-theme="light"] .traf-chart-title,
[data-theme="light"] .cfg-label,
[data-theme="light"] .sub-card-name-v2{text-shadow:none}
[data-theme="light"] .nav-it.on{text-shadow:none}
/* ══════ Telegram Bot Panel ══════ */
.tg-panel{background:linear-gradient(155deg,var(--bg3) 0%,var(--card) 60%);border:1px solid var(--card-b);border-radius:22px;overflow:hidden;box-shadow:var(--shadow);position:relative}
.tg-panel::before{content:'';position:absolute;top:-60px;right:-60px;width:200px;height:200px;background:radial-gradient(circle,rgba(41,162,220,.14),transparent 70%);pointer-events:none}
.tg-hero{display:flex;align-items:center;gap:14px;padding:22px 24px 18px;position:relative;z-index:1}
.tg-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,#29A2DC,#186EA5);display:flex;align-items:center;justify-content:center;color:#fff;font-size:24px;flex-shrink:0;box-shadow:0 6px 18px rgba(41,162,220,.35)}
.tg-hero-text{flex:1;min-width:0}
.tg-hero-title{font-size:15px;font-weight:800;color:var(--t1)}
.tg-hero-sub{font-size:10.5px;color:var(--t3);margin-top:3px}
.tg-hero-status{width:12px;height:12px;border-radius:50%;background:var(--t3);flex-shrink:0;box-shadow:0 0 0 3px rgba(0,0,0,.08)}
...
.tg-field label i{color:#29A2DC;font-size:14px}
.tg-hint{font-weight:500;color:var(--t3);text-transform:none;letter-spacing:0;font-size:9.5px}
.tg-input-wrap{position:relative}
.tg-input{width:100%;padding:11px 42px 11px 14px;border-radius:11px;border:1px solid var(--card-b);background:rgba(0,0,0,.18);color:var(--t1);font-family:ui-monospace,monospace;font-size:12.5px;outline:none;transition:.15s}
[data-theme="light"] .tg-input{background:#fff}
.tg-input:focus{border-color:rgba(41,162,220,.55);box-shadow:0 0 0 3px rgba(41,162,220,.12)}
.tg-eye{position:absolute;left:12px;top:50%;transform:translateY(-50%);background:none;border:none;color:var(--t3);cursor:pointer;font-size:16px;padding:4px;display:flex}
.tg-eye:hover{color:#29A2DC}
.tg-actions{display:flex;gap:8px;flex-wrap:wrap}
.tg-result{margin-top:12px;padding:10px 14px;border-radius:10px;font-size:12px;font-weight:600;display:flex;align-items:center;gap:8px}
.tg-result.ok{background:var(--green-bg);color:var(--green-t);border:1px solid rgba(16,185,129,.25)}
...
<section class="pg" id="pg-settings">
  ...
  <div class="g2">
    ...
    <!-- ══════ Telegram Bot Panel ══════ -->
    <div class="tg-panel" style="grid-column:1/-1">
      <div class="tg-hero">
...
function navTo(name){
  ...
  const loaders={links:loadLinks,connections:loadConns,errors:loadErrs,subscriptions:loadSubsPage,subgroups:loadSubs,logs:loadActivity,settings:()=>{loadAccount();tgLoad();}};
